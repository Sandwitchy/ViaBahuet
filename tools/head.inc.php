...
<html lang="en">
  ...
  <head>
    <?php
      ...
      session_start();
      if (!isset($_SESSION['user_info'])) //verifie si un user s'est correctement connecté sinon revoie vers la page de connexion
      {
        echo "<script type='text/javascript'>document.location.replace('index.php');</script>";
      }else {
        $GLOBAL_ouser = $_SESSION['user_info']; // définition de la variable global de l'user connecté
        $GLOBAL_ouser->recupUser($conn);
      }
     ?>
    <meta charset="utf-8">
